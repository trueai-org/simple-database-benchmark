...
echo ""
echo "连接信息:"
echo "  MySQL:      localhost:33306  root/123456"
echo "  SQLServer:  localhost:31433  sa/Benchmark@123"
echo "  PostgreSQL: localhost:35432  postgres/123456"
echo "  MongoDB:    localhost:37017"
