...
Write-Host ""
Write-Host "连接信息:"
Write-Host "  MySQL:      localhost:33306  root/123456"
Write-Host "  SQLServer:  localhost:31433  sa/Benchmark@123"
Write-Host "  PostgreSQL: localhost:35432  postgres/123456"
Write-Host "  MongoDB:    localhost:37017"
